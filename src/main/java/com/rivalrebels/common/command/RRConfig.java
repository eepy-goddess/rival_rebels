    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if(args.length == 2){
            ...
            if(str.equals("enable_old_nuke")){
                ...
                String str3 = "§e|if you are getting this message, try typing the command again. If that doesn't work, report this to the rival rebels website|".substring(1) + "§r".substring(1);
                if(i){
                    str3 = "will";
                } else if(!i){
