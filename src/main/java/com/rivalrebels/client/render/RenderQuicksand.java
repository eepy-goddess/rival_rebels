...
public class RenderQuicksand extends TileEntitySpecialRenderer<TileQuickSand> {
    @Override
    public void render(TileQuickSand te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        renderBlock(te, x, y, z, te.getWorld());
    }
    public void renderBlock(TileQuickSand te, double x, double y, double z, World world){
