...
public class RenderNuke extends TileEntitySpecialRenderer<TileNuke> {
    public static ResourceLocation texture = new ResourceLocation(ModInfo.modid, "textures/models/wack_nuke.png");
    public static ResourceLocation model_loc = new ResourceLocation(ModInfo.modid, "models/obj/wacknuke.obj");
    public static ResourceLocation old_nuke_texture = new ResourceLocation(ModInfo.modid, "textures/models/old_nuke.png");
    ...
    public void render(TileNuke te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if(RRConfigOptions.render_old_nuke) {
